                ...
                try {
                    ...
                    if (i == 0) {
                        ...
                        while (n != 3) {
                            ...
                            if(daño == 0){
                                System.out.println(humanos.get(i).getNombre() + " ataca a " + troll.getNombre() + " con "
                                    + humanos.get(i).getAtaque());
                                System.out.println("[" + troll.getSalud() + "]" + "-" + "[falla] = ["
                                    + (troll.getSalud() - daño) + "]");
                                ...
                                System.out.println(humanos.get(i).getNombre() + " ataca a " + troll.getNombre() + " con "
                                    + humanos.get(i).getAtaque());
                                System.out.println("[" + troll.getSalud() + "]" + "-" + "[" + daño + "] = ["
                                    + (troll.getSalud() - daño) + "]");
                                troll.setSalud(troll.getSalud() - daño);
                                n++;
                            }
                ...
                try {
                    ...
                    switch ((int) (Math.random() * 3 + 1)) {
                        case 1:
                            ...
                            daño = ataqueEspada.atacar();
                            if(daño == 0){
                                System.out.println(monstruos.get(i).getNombre() + " ataca a " + humano.getNombre() + " con "
                                    + monstruos.get(i).getAtaque());
                                System.out.println("[" + humano.getSalud() + "]" + "-" + "[falla] = ["
                                    + (humano.getSalud() - daño) + "]");
                                humano.setSalud(humano.getSalud() - daño);
                                break;
                            }else{
                                System.out.println(monstruos.get(i).getNombre() + " ataca a " + humano.getNombre() + " con "
                                    + monstruos.get(i).getAtaque());
                                System.out.println("[" + humano.getSalud() + "]" + "-" + "[" + daño + "] = ["
                                    + (humano.getSalud() - daño) + "]");
                                humano.setSalud(humano.getSalud() - daño);
                                break;
                            }
